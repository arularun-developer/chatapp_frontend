        ...
        <Fragment>
            {
                ...
                >
                    <div className="flex justify-between bg-neutral-900  border-b border-zinc-800 px-2 lg:px-4 py-2 ">
                        <div className="flex flex-none space-x-1 md:space-x-3 items-center">
                            ...
                            <div className="flex flex-col pl-1 md:pl-0 max-w-[170px] md:max-w-[480px]  text-zinc-100">
                                        ...
                                        <span className='truncate'>
                                            {
                                                selectUser.users.map((u,i)=>
                                                    <span key={i} className='text-xs truncate md:text-sm  text-zinc-100'>{u.firstname+", "}</span>
                                                )
                                            }
                                        </span>
                                        :
                                        <span className='truncate text-xs md:text-sm  text-zinc-100'>
                                            {
                                                getOnline(selectUser, onlineUsers, getUserDetails()) ?
                                                    'Active Now'
                                                    :
                    ...
                    <div className="flex space-x-2 items-center bg-neutral-800  px-3 lg:px-6 py-2  border-x">
