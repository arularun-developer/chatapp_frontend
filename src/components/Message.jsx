                                                ...
                                                <div className="flex w-full space-x-3 max-w-sm ml-auto justify-end">
                                                    {
                                                        isSenderSingleMsg(messages, msg, i) ||
                                                            ...
                                                            (
                                                                <div className="bg-[#3B71CA] text-black p-2 mt-1 ml-24 md:ml-0 rounded-l-[20px] rounded-r-[20px]">
                                                                    <p className="text-sm font-normal px-1 md:px-3">{msg.content}</p>
                                                                </div>
                                                            ) : isSamesenderUpperMsg(messages, msg, i) ?
                                                                (
                                                                    <div className="bg-[#3B71CA] mt-1 text-black p-2 ml-24 md:ml-0 rounded-tr-[20px] rounded-br-md rounded-l-[20px]">
                                                                        <p className="text-sm font-normal px-1 md:px-3">{msg.content}</p>
                                                                    </div>
                                                                ) : isSamesenderLowerMsg(messages, msg, i) ?
                                                                    (
                                                                        <div className="bg-[#3B71CA] text-black p-2 ml-24 md:ml-0 rounded-l-[20px] rounded-br-[20px] rounded-tr-md">
                                                                            <p className="text-sm font-normal px-1 md:px-3">{msg.content}</p>
                                                                        </div>
                                                                    ) : (
                                                                        <div className="bg-[#3B71CA] text-black p-2 ml-24 md:ml-0 rounded-l-[20px] rounded-r-md">
                                                                            <p className="text-sm font-normal px-1 md:px-3">{msg.content}</p>
                                                                        </div>
                                                                    )
                                                    }
                                                                ...
                                                                <div className='flex w-full space-x-3'>
                                                                    <div className="flex-shrink-0 h-8 w-8 mt-auto rounded-full relative">
                                                                        <img className="object-cover w-8 h-8 rounded-full" src={msg.sender.photo} alt="Sender pic" />
                                                                        {
                                                                            onlineUsers.find((u) => u.userId === msg.sender._id)
                                                                            &&
                                                                            <span className="h-2 w-2 rounded-full absolute right-0.5 ring-2 ring-gray-300 bottom-0"></span>
                                                                        }
                                                                    </div>
