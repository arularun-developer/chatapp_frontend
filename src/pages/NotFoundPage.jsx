            ...
            <section className="bg-white h-full">
                <div className="p-8 m-auto max-h-screen max-w-screen-xl">
                    <div className="mx-auto max-w-screen-sm text-center">
                        ...
                        <Link to={getToken()? '/login' : '/login'} className="inline-flex text-white bg-primary-600 hover:bg-[#0f4d50] focus:ring-4 focus:outline-none focus:ring-[#4dd6dd] font-medium rounded-lg text-sm px-5 py-2.5 text-center my-4">Back to Homepage</Link>
                    </div>
                </div>
            </section>
        </Fragment>
